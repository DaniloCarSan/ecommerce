            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="<?php if( $active=='home' ){ ?> active<?php } ?>"><a href="/">Home</a></li>
                        <li class="<?php if( $active=='product' ){ ?> active <?php } ?>"><a href="#">Produtos</a></li>
                        <li class="<?php if( $active=='cart' ){ ?> active <?php } ?>"><a href="/cart">Carrinho</a></li>
                    </ul>
                </div>  
            </div>
        </div>
