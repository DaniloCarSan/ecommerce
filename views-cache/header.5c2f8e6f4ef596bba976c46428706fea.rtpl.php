        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo htmlspecialchars( $_SESSION['User']['desphoto'], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo htmlspecialchars( $_SESSION['User']['desphoto'], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo BASE_URL; ?>admin/categories"><i class="fa fa-th-list"></i> <span>Categorias</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>admin/products"><i class="fa fa-th-list"></i> <span>Produtos</span></a></li>
        <li class="treeview">
