          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                   <?php echo htmlspecialchars( $_SESSION["User"]["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?>- Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li ><a href=" <?php echo BASE_URL; ?>admin/users"><i class="fa fa-users"></i>Usuários <span></span></a></li>
